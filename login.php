        ...
        <div class="wrapper">
            <div class="auth-content">
                <div class="card">
                    <div class="card-body text-center">
                        ...
                        <form action="login_entry.php" method="post">
                            <div class="mb-3 text-start">
                                <label for="text" class="form-label">USN</label>
                    ...
                    <p class="mb-2 text-muted"><a href="admin/admin_login.php">Admin</a></p>

                        <p class="mb-0 text-muted">Don't have account yet? <a href="signin.php">Signin</a></p>
                    </div>
                </div>
            </div>
        </div>
