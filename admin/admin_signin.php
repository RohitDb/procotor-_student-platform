            ...
            <div class="card">
                <div class="card-body text-center">
                    ...
                    <form action="admin_entry.php" method="post">
                        ...
                        <div class="mb-3 text-start">
                            <label for="usn" class="form-label">Id</label>
                            <input type="text" class="form-control" placeholder="Enter ID" name="id"required>
                        </div>
                        <div class="mb-3 text-start">
                            <label for="email" class="form-label">Email</label>
                            <input type="text" class="form-control" placeholder="Enter ID" name="email" required>
                        </div>
                        <div class="mb-3 text-start">
                    ...
                    <p class="mb-0 text-muted">Already have an account? <a href="admin_login.php">Log in</a></p>
                </div>
            </div>
        </div>
    </div>
